...
==**선불 교통카드**는==
==태그할 때 **남은 잔액**을 확인할 수 있어.==
버스를 타기 전 한 번 확인하면
갑작스러운 잔액 부족을 예방할 수 있지~!

반대로 *후불 교통카드*는
잔액 대신 지금까지 *이용한 금액*이 표시되고,
나중에 한 번에 결제돼.

이제 교통카드를 태그할 때
__화면에 어떤 정보가 표시되는지__
한 번 살펴보자! 💳`,
  },
  {
    id: "subway",
...
__전동기가 전기에너지를 **운동에너지**로 바꾸면__
==연결된 바퀴가 회전하면서 지하철이 움직이지.==

다음에 지하철을 탈 때,
수많은 사람을 움직이는 숨은 과학을 떠올려 보자!`,
  },
  {
    id: "ship",
    exhibitId: "B31",
...
배는 어떻게 움직이고,
왜 멀미가 나는지 알아보자!`,
    complete: `멀미는 단순히 배가 흔들려서 생기는 게 아니야.

**눈**이 느끼는 움직임과
**귀** 속 평형기관이 느끼는 움직임이
__서로 다를 때 몸이 **혼란**을 느끼면서__
**멀미**가 생기는 거야.

멀미는 배뿐만 아니라
자동차, 버스, 비행기를 탈 때도 생길 수 있어!

멀미가 걱정된다면,
==출발하기 30분~1시간 전에 멀미약==을 먹거나
붙이면 훨씬 편안하게 여행할 수 있어! 💊✨`,
  },
];
...
export const questions: Question[] = [
  ...
  },
  {
    ...
    answerIndex: 2,
    explanation:
      "교통카드 안에는 건전지가 없어요. 단말기에 가까이 가져가면 유도코일에 유도전류가 만들어져 IC칩이 작동하고, 정보가 전달돼요.",
  },
  {
    id: "q6",
    exhibitId: "B16",
